...
\begin{figure}[H]
    \centering
    \includegraphics[width=1.2\linewidth]{docs\RelazioneTD\images\defense_model.JPG}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1.1\linewidth]{docs\RelazioneTD\images\entity_factory.JPG}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{docs\RelazioneTD\images\defense_manager.JPG}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{docs\RelazioneTD\images\defense_observer.jpg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{docs\RelazioneTD\images\defense_target.JPG}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{docs\RelazioneTD\images\defense_attack.JPG}
